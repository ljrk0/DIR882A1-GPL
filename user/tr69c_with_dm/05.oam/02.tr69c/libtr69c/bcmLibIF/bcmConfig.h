...
#if defined(SUPPORT_DM_LEGACY98)
#define saveLastConnectedURL()  saveLastConnectedURL_igd()
#elif defined(SUPPORT_DM_HYBRID)
#define saveLastConnectedURL()  saveLastConnectedURL_igd()
#elif defined(SUPPORT_DM_PURE181)
#define saveLastConnectedURL()  saveLastConnectedURL_dev2()
#elif defined(SUPPORT_DM_DETECT)
#define saveLastConnectedURL()  (cmsMdm_isDataModelDevice2() ? \
