...
typedef struct {
   ...
   int             length; /* the length of the memory to keep the content */
   int             maxlength; /* the max length of the memory to keep the content */
   char           *content; /* the memory to keep the content */
} tProtoCtx;
