...
//		struct sockaddr_in *ptemp = (struct sockaddr*)p->ai_addr;
//		short port = ntohs(ptemp->sin_port);
//		char *addrtmp = inet_ntoa(sin.sin_addr);
//printf("=addr %s %d =====addrlen %d =====\n",addrtmp,port,p->ai_addrlen);		
