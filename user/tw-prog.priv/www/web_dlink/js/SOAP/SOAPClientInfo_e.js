 ...
 * @constructor
 */
function SOAPStationInfoResponse()
{
	this.StationName = "";
	this.StationMAC = "";
	this.StationMode = "";
 ...
 * @constructor
 */
function SOAPStationInfoListsResponse()
{
	var stationInfo = new SOAPStationInfoResponse();

	this.StationInfo = $.makeArray(stationInfo);
};
 ...
 * @constructor
 */
function SOAPGetPLCStationInfoResponse()
{
	this.StationInfoLists = new SOAPStationInfoListsResponse();
};
