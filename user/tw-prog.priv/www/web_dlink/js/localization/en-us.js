{
	...
	"ISP often specify speed as a download/upload pair; for example 1.5Mbps/0.25Mbps.  You can measure your upload and download speed with a speed test service on the internet.": "ISP often specify speed as a download/upload  pair; for example 1.5Mbps/0.25Mbps.  You can measure your upload and download speed with a speed test service on the internet.",
	...
	"Your password must be between 8-64 characters length": "Your password must be between 8-64 characters length",
	...
	"Please enter a value between 1 and 128": "Please enter a value between 1 and 128.",
	...
	"Please enter a value between 0 and 65535": "Please enter a value between 0 and 65535.",
	...
	"err_ipv6address_Check": "Please enter a valid IPv6 address.",
	...
	"Please ensure both Covr Extenders are next to each other, then press the WPS button on the side of the Covr Extender within %s seconds. If done correctly, the Power LED will start flashing.": "Please ensure both Covr Extenders are next to each other, then press the WPS button on the side of the Covr Extender within %s seconds. If done correctly, the Power LED will start flashing.",
	"Plug in both of the Covr Extenders next to your existing router. Connect the Ethernet port of one of the Covr Extenders to the existing router using an Ethernet cable. Wait approximately 120 seconds for the Covr Extenders to power on, then click Next.": "Plug in both of the Covr Extenders next to your existing router. Connect the Ethernet port of one of the Covr Extenders to the existing router using an Ethernet cable. Wait approximately 120 seconds for the Covr Extenders to power on, then click Next.",
	"We could not detect your Covr Extender. Click Retry to try again, or click Skip Covr Setting to skip adding a Covr Extender at this time.": "We could not detect your Covr Extender. Click Retry to try again, or click Skip Covr Setting to skip adding a Covr Extender at this time.",
	"You may now unplug the Covr Extender and place it in a location where the Wi-Fi signal is weak.": "You may now unplug the Covr Extender and place it in a location where the Wi-Fi signal is weak.",
	"SAMBA": "SAMBA",
	"FTP": "FTP",
	"VPN": "VPN",
	...
	"Use this section to configure the Powerline settings for your D-Link Extender.": "Use this section to configure the Powerline settings for your D-Link Extender.",
	...
	"Exiting now will result in Covr not being setup!": "Exiting now will result in COVR not being setup!",
	...
	"Choose a IPv4 provisioning mechanism to be used by the device.": "Choose an IPv4 provisioning mechanism to be used by the device.",
	"Choose a IPv6 provisioning mechanism to be used by the device.": "Choose an IPv6 provisioning mechanism to be used by the device.",
	...
	"Device name given is invalid.": "Device name given is invalid.",
	...
	"The Wi-Fi Network Name can be up to 32 characters long.": "The Wi-Fi Network Name can be up to 32 characters long.",
	"You need to give your extended Wi-Fi network a name (SSID) and a password. You can then connect to this extended Wi-Fi network using the password you have chosen.": "You need to give your extended Wi-Fi network a name (SSID) and a password. You can then connect to this extended Wi-Fi network using the password you have chosen.",
	"WEP": "WEP",
	...
	"Please enter the Wi-Fi password for your existing Wi-Fi network": "Please enter the Wi-Fi password for your existing Wi-Fi network",
	"Please choose the Wi-Fi network you would like to extend.": "Please choose the Wi-Fi network you would like to extend.",
	"Extend an existing wireless network": "Extend an existing wireless network",
	"Add wireless to your wired network": "Add wireless to your wired network",
	"Step 1: Connecting your device": "Step 1: Connecting your device",
	"Step 2: Configuring your settings": "Step 2: Configuring your settings",
	"Step 3: Setting a password for your device": "Step 3: Setting a password for your device",
	"Existing Router": "Existing Router",
	"DNS Server": "DNS Server",
	"Uplink Router": "Uplink Router",
	"Unknown": "Unknown",
	"Select a Wi-Fi network to extend": "Select a Wi-Fi network to extend",
	"Configuration": "Configuration",
	"We couldn't find a Wi-Fi network through WPS. Click <b>Retry</b> to try again, or select a connection method below.": "We couldn't find a Wi-Fi network through WPS. Click <b>Retry</b> to try again, or select a connection method below.",
	...
	"This wizard will guide you through a step-by-step process to configure your Covr Wi-Fi system.": "This wizard will guide you through a step-by-step process to configure your COVR Wi-Fi system.",
	...
	"Step 4: Relocate Covr Wi-Fi Extender": "Step 4: Relocate Covr Wi-Fi Extender",
	"Link Rate": "Link Rate",
	"You may now <span style='color:red;'>plug</span> the Covr Extender and place it in a location <b>between your Covr Router and the Wi-Fi weak area or deadzone.</b> Once placed, verify that <b>all five LEDs are solid green.</b> If the two uplink LEDs are not solid green move the Covr Extender closer to the Covr Router until they are.": "You may now <span style='color:red;'>plug</span> the Covr Extender and place it in a location <b>between your Covr Router and the Wi-Fi weak area or deadzone.</b> Once placed, verify that <b>all five LEDs are solid green.</b> If the two uplink LEDs are not solid green move the Covr Extender closer to the Covr Router until they are.",
	...
	"Covr Extender Placement": "Covr Extender Placement",
	"Internet Service Provider": "Internet Service Provider",
	"Internet VLAN": "Internet VLAN",
	"IPTV VLAN": "IPTV VLAN",
	"VOIP VLAN": "VOIP VLAN",
	"Interface Traffic Type Setting": "Interface Traffic Type Setting",
	...
	"VPN Profile For iOS Device and Mac OS X": "VPN Profile for iOS Device and Mac OS X",
	"Operation Mode": "Operation <Mode></Mode>",
	"The device acts as an Router to connect your device together.": "The device acts an an Router to connect your device together.",
	"The device acts as a Extender to extend the range of an existing wireless network.  You can use this to extend the coverage of an existing wireless router.": "The device acts as a Extender to extend the range of an existing wireless network.  You can use this to extend the coverage of an existing wireless router.",
	"Note however that sites such as DSL Reports, because they do not consider as many network protocol overheads, will generally slightly lower than the Measured Upload Speed or the ISP rated speed.": "Note however that sites such as DSL Reports, because they do not consider as many network protocol overheads, will generally slightly lower than the Measured Upload Speed or the ISP rated speed.",
	"Operation Mode Settings": "Operation Mode Settings",
	"Internet Service Providers (ISPs) often specify speed as a download/upload  pair; for example 1.5Mbps/0.25Mbps.  You can measure your upload and download speed with a speed test service on the Internet. Please note, sites that provide this service such as DSL Reports, does not take into consideration many network protocol overheads and will generally slightly lower values than the specified upload speeds from your ISP.": "Internet Service Providers (ISPs) often specify speed as a download/upload  pair; for example 1.5Mbps/0.25Mbps.  You can measure your upload and download speed with a speed test service on the Internet. Please note, sites that provide this service such as DSL Reports, does not take into consideration many network protocol overheads and will generally slightly lower values than the specified upload speeds from your ISP.",
	"Turn Parental Control on with BLOCK rules": "Turn Parental control on with BLOCK rules",
	"Turn Parental Control on with ALLOW rules": "Turn Parental Control on with ALLOW rules",
	"Reserved IP address should be within the configured DHCP range.": "Reserved IP address should be within the configured DHCP range.",
	...
	"(GMT-05:00) Bogota, Lima, Quito, Indiana (East)": "(GMT-05:00) Bogota, Lima, Quito, Indiana (East)",
	...
	"(GMT+04:00) Moscow, St. Petersburg, Volgograd": "(GMT+04:00) Moscow, St. Petersburg, Volgograd",
	...
	"DFS Channel": "DFS Channel",
	"IPTV Connection is": "IPTV Connection is",
	"VOIP Connection is": "VOIP Connection is",
	"Your device operation mode is": "Your device operation mode is",
	"Extender Mode": "Extender Mode",
	"Please Enable DHCP Server first.": "Please Enable DHCP Server first.",
	"You may now plug the Covr Point(s) and place it in a location between your Covr Router and the Wi-Fi weak area or deadzone.  Once placed, verify that the COVR LEDs are solid white. If the COVR LEDs are not solid white, move the Covr Point(s) closer to the Covr Router until they are.": "You may now plug the COVR Point(s) and place it in a location between your COVR Router and the Wi-Fi weak area or deadzone.  Once placed, verify that the COVR LEDs are solid white. If the COVR LEDs are not solid white, move the COVR Point(s) closer to the COVR Router until they are.",
	"Click for diagnostics_ford3": "Click for diagnostics",
	"Diagnostics": "Diagnostics",
	"Mesh Network": "Mesh Network",
	"Extenders": "Extenders",
	"Data error": "Data error",
	"Traffic Utilization": "Traffic Utilization",
	"This page gives you various statistics about data transmitted and received by your router through the Internet, your wired network (LAN), and through your wireless networks.": "This page gives you various statistics about data transmitted and received by your router through the Internet, your wired network (LAN), and through your wireless networks.",
	"Step 4: Relocate Covr Point(s)": "Step 4: Relocate COVR Point(s)",
	"COVR router": "COVR router",
	"COVR point": "COVR point",
	"Covr Point(s) Placement": "COVR Point(s) Placement",
	"Power off the modem and connect one end of an Ethernet cable to the port 1 on the cover point labeled A, and connect the other end to your modem or Internet-connected Ethernet wall jack. Power the modem back on.":"Power off the modem and connect one end of an Ethernet cable to the port 1 on the cover point labeled A, and connect the other end to your modem or Internet-connected Ethernet wall jack. Power the modem back on.",
	"You may now plug the Covr Point(s) and place it in a location between your Covr Point A and the Wi-Fi weak area or deadzone.  Once placed, verify that the COVR LEDs are solid white. If the COVR LEDs are not solid white, move the Covr Point(s) closer to the Covr Point A until they are.": "You may now plug the COVR Point(s) and place it in a location between your COVR Point A and the Wi-Fi weak area or deadzone.  Once placed, verify that the COVR LEDs are solid white. If the COVR LEDs are not solid white, move the COVR Point(s) closer to the COVR Point A until they are.",
	"The Wi-Fi network and Guest Wi-Fi network cannot have the same name (SSID).": "The Wi-Fi network and Guest Wi-Fi network cannot have the same name (SSID).",
	"IPv6 PPPoE is share with IPv4 PPPoE. Please change IPv6 PPPoE setting from \"Share with IPv4\" to \"Create a new session\" firstly.": "IPv6 PPPoE is share with IPv4 PPPoE. Please change IPv6 PPPoE setting from \"Share with IPv4\" to \"Create a new session\" firstly.",
	"COVR EXTENDER REPLACEMENT": "COVR EXTENDER REPLACEMENT",
	"D-Link Cloud Service enables third-party service integration for your device through the cloud. Please view your account information that is currently associated with your device's D-Link Cloud acount. <br> To find out more about D-Link Cloud's features, simply download the D-Link Wi-Fi App from the App Store or Google Play<sup>TM</sup> to your mobile device.": "D-Link Cloud Service enables third-party service integration for your device through the cloud. Please view your account information that is currently associated with your device's D-Link Cloud acount. <br> To find out more about D-Link Cloud's features, simply download the D-Link Wi-Fi App from the App Store or Google Play<sup>TM</sup> to your mobile device.",
	"D-Link Cloud Registration": "D-Link Cloud Registration",
	...
	"Set the download and upload speed based on your ISP subscription plan in order to adjust the QoS engine to provide precise client priorities.": "Set the download and upload speed based on your ISP subscription plan in order to adjust the QoS engine to provide precise client priorities.",
	...
	"The name may contain alphanumeric, underscores, hyphens, and spaces. The name cannot begin with, end with, or consist only of spaces.": "The name may contain alphanumeric, underscores, hyphens, and spaces. The name cannot begin with, end with, or consist only of spaces."
}