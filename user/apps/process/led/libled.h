...
int cmd_config_int_exit(struct cli_def *cli, UNUSED(char *command),UNUSED(char *argv[]), UNUSED(int argc));
int cmd_test(struct cli_def *cli, char *command, char *argv[], int argc);
int cmd_config_int(struct cli_def *cli, UNUSED(char *command), char *argv[], int argc);
int cmd_led_regular_start(struct cli_def *cli, UNUSED(char *command), char *argv[], int argc);
int cmd_led_regular_stop(struct cli_def *cli, UNUSED(char *command), char *argv[], int argc);
...
int cli_loop_cli(struct cli_def *cli, int rsockfd, int sockfd, char *cli_cmd);
