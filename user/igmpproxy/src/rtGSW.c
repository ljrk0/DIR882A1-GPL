...
{
	unsigned int value;
#if !defined (CONFIG_RALINK_MT7621) && !defined (CONFIG_ARCH_MT7623) && !defined (CONFIG_P5_RGMII_TO_MT7530_MODE)
	/*IGMP forward to cpu*/
	/* 10110014 */
...
#if (defined (CONFIG_RALINK_MT7621) || defined (CONFIG_ARCH_MT7623)) && defined (CONFIG_RAETH_GMAC2)
