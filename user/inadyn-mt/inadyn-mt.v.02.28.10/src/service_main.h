...
#define SVC_LONG_OPTION_INSTALL		"--install"
#define SVC_LONG_OPTION_START		"--start"
#define SVC_LONG_OPTION_NAME		"--name"
#define SVC_LONG_OPTION_RESTART		"--restart"
#define SVC_LONG_OPTION_EXIT		"--exit"
#define SVC_LONG_OPTION_UNINSTALL	"--uninstall"

typedef DWORD SERVICE_EVENT;
typedef DWORD (*SERVICE_CLIENT_ENTRY)(int argc, char* argv[],int is_service,FILE *pLOG_FILE);
