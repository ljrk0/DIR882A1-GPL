...
static CMD_DESCRIPTION_TYPE service_cmd_options_table[] =
{
        ...
        {SVC_LONG_OPTION_START,0,{service_start_handler,NULL,0},""},
        {"-n",0,{service_name_handler,NULL,0},""},
        {SVC_LONG_OPTION_NAME,0,{service_name_handler,NULL,0},""},
...
int wmain(int argc, char* argv[])
{
	...
	#define SERVICE_DESC	L"Updates a user configured dynamic dns server to IP address changes."


	#define REG_DEFAULT	L"--input_file .\\inadyn-mt.conf"
