...
/* send_discover_dis和init_packet_dis这两函数是专门为dhcpc-discovery.c生成udhcpc-discovery命令准备的，
	它避免了在dhcpc-discovery.c中调用send_discover进而调用init_packet造成的segment fault 
*/
