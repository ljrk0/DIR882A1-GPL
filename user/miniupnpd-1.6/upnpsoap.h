...
#define UPNP_STRING_MAXLEN  26
#define UPNP_SAVEFILE_MODE  /*选择中间文件模式*/
#define MINIUPNP_DEBUG
#ifdef  UPNP_SAVEFILE_MODE
#define   BACKFILE  "/var/mapback.conf"
#define   MAPFILE   "/var/portmapinfo.conf"
#else
#endif
