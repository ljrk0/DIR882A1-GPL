...
#if 1//(LINUX_VERSION_CODE >= KERNEL_VERSION(2, 6, 10))
...
#if 0//(LINUX_VERSION_CODE < KERNEL_VERSION(2, 6, 25))
...
#if 1//(LINUX_VERSION_CODE >= KERNEL_VERSION(3,12,0))
