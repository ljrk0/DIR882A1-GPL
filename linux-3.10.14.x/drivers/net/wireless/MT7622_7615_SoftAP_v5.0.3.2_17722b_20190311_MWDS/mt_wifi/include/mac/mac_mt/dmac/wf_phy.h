...
#define CR_WF3_RFINTF_00	(WF_PHY_BASE + 0x1100)
#define CR_WF3_RFINTF_01	(WF_PHY_BASE + 0x1500)
#define CR_WF3_RFINTF_02	(WF_PHY_BASE + 0x1900)
#define CR_WF3_RFINTF_03	(WF_PHY_BASE + 0x1D00)
#define CR_RFINTF_ENABLE_ANT_MASK (0xf << 4)
#define CR_RFINTF_ENABLE_ANT(p) (((p) & 0xf) << 4)
