...
#define RT_OID_GET_ROOTAP_LINKRATE				   0x765
#define RT_OID_GET_ROOTAP_CONN_STATE 			   0x766
...
/*Add by T&W Sudenghai 2014-10-31, 支持获取无线的信号质量等参数*/
#define RT_OID_GET_LINK_RSSI                	    0x0804
/*End by T&W Sudenghai 2014-10-31*/
...
typedef struct _COMMON_CONFIG_INFO {
    UCHAR Channel;
	UCHAR CentralChannel;	/* Central Channel when using 40MHz is indicating. not real channel. */
    UINT32 BW;	/*channel bandwidth 20MHz or 40 MHz */
    UINT32 EXTCHA;
} COMMON_CONFIG_INFO, *PCOMMON_CONFIG_INFO;
