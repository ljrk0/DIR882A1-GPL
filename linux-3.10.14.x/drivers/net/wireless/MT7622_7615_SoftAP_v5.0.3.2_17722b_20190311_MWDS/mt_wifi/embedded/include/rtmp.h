...
typedef struct _MAC_TABLE_ENTRY {
	...
	*/
	...
	USHORT PortSecured;
	/*T&W add by sudenghai 2015-1-4 for identify fake connection*/
	BOOLEAN PortTrueSecured;	/*T&W See if Port is real true secure */
...
typedef struct _APCLI_STRUCT {
	...
	/*Add by Sudenghai 2014-10-31 用于保存apcli的rssi*/
	RSSI_SAMPLE RssiSample;
	/*End by Sudenghai 2014-10-31*/
...
#endif /* SINGLE_SKU_V2 */
	ULONG  up_time;//Add by T&W, wlan up time
...
//T&W 2013-12-20 linsd add connect status, code from chenqi 
...
/*Add by T&W Sudenghai 2014-5-29*/
VOID RTMPIoctlGetAssocStaMac(
	IN	PRTMP_ADAPTER	pAdapter, 
	IN	RTMP_IOCTL_INPUT_STRUCT *wrq);
/*End by T&W Sudenghai 2014-5-29*/

//add by wyh start at 2014-05-15
VOID RTMPIoctlGetVituralMac(
    IN PRTMP_ADAPTER pAd,
    IN RTMP_IOCTL_INPUT_STRUCT *wrq);
//add by wyh end

/*add by taogan*/
VOID RTMPIoctlGetWlanInfo(
	IN PRTMP_ADAPTER pAd,
	IN  RTMP_IOCTL_INPUT_STRUCT *wrq);
/*add end taogan*/
