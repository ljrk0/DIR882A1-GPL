...
#if defined (CONFIG_SUPPORT_WIFI_CERT)
#define WIFI_CER_SUPPORT 1
#endif
/* WSC OUI SMI */
...
/* T&W vvv */
enum {
       STATUS_WSC_USER_IDEL,
       STATUS_WSC_USER_SUCCESS,
       STATUS_WSC_USER_TIMEOUT,
       STATUS_WSC_USER_OVERLAP,
};
/* T&W ^^^ */
...
/* Common definition */
#if 1//defined(PRODUCT_DIR853_A1) || defined(PRODUCT_DIR853_A2)
...
#if 1//defined(PRODUCT_DIR853_A1) || defined(PRODUCT_DIR853_A2)
#define	AP_WSC_MODEL_NAME		"DIR-853"
#define	AP_WSC_DEVICE_NAME		"DIR-853"
#else
...
#if 1//defined(PRODUCT_DIR853_A1) || defined(PRODUCT_DIR853_A2)
#define	WSC_MODEL_NUMBER	"DIR-853"
#else
