    ...
    RTMP_STRING *arg)
{
	...
	MTWF_LOG(DBG_CAT_PROTO, CATPROTO_DFS, DBG_LVL_OFF, ("In Set_RadarDetectStart_Proc: pDfsParam->DetRateMode=%d\n",pDfsParam->DetRateMode));	
...
#endif	
			MTWF_LOG(DBG_CAT_PROTO, CATPROTO_DFS, DBG_LVL_OFF, ("In Set_RadarDetectStart_Proc: Bandwidth not 80+80 or 160\n"));
    ...
    RTMP_STRING *arg)
{
	...
	value = simple_strtol(arg, 0, 10);
	MTWF_LOG(DBG_CAT_PROTO, CATPROTO_DFS, DBG_LVL_OFF, ("In Set_ByPassCac_Proc\n"));		 
	...
	IN RTMP_STRING *arg)
{
    ...
    {
	    MTWF_LOG(DBG_CAT_PROTO, CATPROTO_DFS, DBG_LVL_OFF, ("No 5G band channel\n"));	 
	}
	else	
	{
	    MTWF_LOG(DBG_CAT_PROTO, CATPROTO_DFS, DBG_LVL_OFF, ("Channel num is %d\n", 
	...
	IN RTMP_STRING *arg)
{
	...
	MTWF_LOG(DBG_CAT_PROTO, CATPROTO_DFS, DBG_LVL_OFF, ("Current Bw is %d\n", 
	...
	IN RTMP_STRING *arg)
{
    ...
    MTWF_LOG(DBG_CAT_PROTO, CATPROTO_DFS, DBG_LVL_OFF, ("RDMode is %d\n", 
            pAd->Dot11_H.RDMode));  
	...
	IN RTMP_STRING *arg)
{
	...
	MTWF_LOG(DBG_CAT_PROTO, CATPROTO_DFS, DBG_LVL_OFF, ("In Set_DfsNonOccupancyShow_Proc: \n"));  
	for(i=0; i<pAd->ChannelListNum; i++)
	{
	    MTWF_LOG(DBG_CAT_AP, DBG_SUBCAT_ALL, DBG_LVL_OFF, ("DfsChannelList[%d].Channel = %d, DfsReq = %d, NonOccupancy = %d\n",
	...
	IN RTMP_STRING *arg)
{
	...
	MTWF_LOG(DBG_CAT_PROTO, CATPROTO_DFS, DBG_LVL_OFF, ("In Set_DfsNonOccupancyClean_Proc:\n"));  
	...
	MTWF_LOG(DBG_CAT_PROTO, CATPROTO_DFS, DBG_LVL_OFF, ("After Set_DfsNonOccupancyClean_Proc:\n"));  
	for(i=0; i<pAd->ChannelListNum; i++)
	{
	    pAd->ChannelList[i].RemainingTimeForUse = value;
	    MTWF_LOG(DBG_CAT_AP, DBG_SUBCAT_ALL, DBG_LVL_OFF, ("DfsChannelList[%d].Channel = %d, DfsReq = %d, NonOccupancy = %d\n",
	...
	IN RTMP_STRING *arg)
{
	...
	MTWF_LOG(DBG_CAT_PROTO, CATPROTO_DFS, DBG_LVL_OFF, ("In Set_DfsPulseInfoShow_Proc: \n"));  
	...
	IN RTMP_STRING *arg)
{
	...
	MTWF_LOG(DBG_CAT_PROTO, CATPROTO_DFS, DBG_LVL_OFF, ("In Set_DfsPulseInfoRead_Proc: \n"));  
    ...
    RTMP_STRING *arg)
{
    ...
    MTWF_LOG(DBG_CAT_PROTO, CATPROTO_DFS, DBG_LVL_OFF, ("[%s]CacTime=%d/%d\n", 
                                __FUNCTION__,
                                Value,
	...
	IN PRTMP_ADAPTER pAd, UCHAR ucRddIdx)
{
...
#endif /* BACKGROUND_SCAN_SUPPORT */
	MTWF_LOG(DBG_CAT_AP, DBG_SUBCAT_ALL, DBG_LVL_OFF, ("[WrapDfsRddReportHandle]:  pDfsParam->NoChSwitch=%d\n",pDfsParam->NoChSwitch));

    if(1 == pDfsParam->NoChSwitch)
    {
	...
	MTWF_LOG(DBG_CAT_AP, DBG_SUBCAT_ALL, DBG_LVL_OFF, ("[WrapDfsRddReportHandle]:  pDfsParam->Dot11_H.RDMode=%d\n",pDfsParam->Dot11_H.RDMode));
	MTWF_LOG(DBG_CAT_AP, DBG_SUBCAT_ALL, DBG_LVL_OFF, ("[WrapDfsRddReportHandle]:  pDfsParam->DetRateMode=%d\n",pDfsParam->DetRateMode));
	MTWF_LOG(DBG_CAT_AP, DBG_SUBCAT_ALL, DBG_LVL_OFF, ("[WrapDfsRddReportHandle]:  Radar detected !!!!!!!!!!!!!!!!!\n"));
	...
	IN PRTMP_ADAPTER pAd)
{
	...
	if((doCal1 & (1 << 1)) != 0)
	{	
		OrigCentralFreq = DfsGetCentCh(pAd, pDfsParam->Band0Ch, pDfsParam->Bw) * 5 + 5000;
