...
WFLAGS += -DRTMP_EFUSE_SUPPORT
ifeq ($(PLATFORM),INTELP6)
WFLAGS += -DCUSTOMER_RSG_FEATURE -DCUSTOMER_DCC_FEATURE
WFLAGS += -DCONFIG_INIT_RADIO_ONOFF
WFLAGS += -DVENDOR1_INITIALIZE_ALL_INTERFACE_AT_INIT
WFLAGS += -DDISABLE_MULTICLIENT_DYNAMIC_TXOP
WFLAGS += -DVENDOR_FEATURE6_SUPPORT
WFLAGS += -DINTELP6_SUPPORT
WFLAGS += -DMULTI_INF_SUPPORT -DMT_SECOND_CARD=7615 -DMT_FIRST_CARD=7615
WFLAGS += -DCON_WPS_AP_SAME_UUID
WFLAGS += -DDOT11U_INTERWORKING_IE_SUPPORT
WFLAGS += -DVENDOR1_LED_SUPPORT
endif
#-DNEW_MBSSID_MODE
WFLAGS += -DCONFIG_ANDES_SUPPORT
