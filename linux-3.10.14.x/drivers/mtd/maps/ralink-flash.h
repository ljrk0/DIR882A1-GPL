...
#endif
#if !defined (MTD_PRIVATE_PART_SIZE)
#error "Please define MTD_PRIVATE_PART_SIZE"
#endif
#else
#define MTD_BOOT_PART_SIZE	0x30000
#define	MTD_CONFIG_PART_SIZE	0x10000
#define	MTD_FACTORY_PART_SIZE	0x10000
#define	MTD_FACTORY_CUSTOM_PART_SIZE	0x10000
...
#define MTD_KERN_PART_SIZE	IMAGE1_SIZE - (MTD_BOOT_PART_SIZE + MTD_CONFIG_PART_SIZE \
				+ MTD_FACTORY_PART_SIZE + MTD_CONFIG_PART_SIZE + MTD_PRIVATE_PART_SIZE)
#else
#define MTD_KERN_PART_SIZE	IMAGE1_SIZE - (MTD_BOOT_PART_SIZE + MTD_CONFIG_PART_SIZE \
